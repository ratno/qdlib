...
class QPaginator extends QPaginatorBase
{
    ...
    public function GetControlHtml()
    {
        ...
        if ($this->intPageNumber <= 1) {
            ...
            $strPrevious = sprintf('<a id="%s" href="%s" %s>%s</a>', $this->ControlId . "_arrow_" . $this->strActionParameter, QApplication::$RequestUri, $this->prxPagination->RenderAsEvents($this->strActionParameter, true, $this->ControlId . "_arrow_" . $this->strActionParameter, false), $this->strLabelForPrevious);
        }
        ...
        if ($this->PageCount <= $this->intIndexCount) {
            ...
            for ($intIndex = 1; $intIndex <= $this->PageCount; $intIndex++) {
                if ($this->intPageNumber == $intIndex) {
                    ...
                    $strToReturn .= sprintf('<span class="page"><a id="%s" href="%s" %s>%s</a></span>', $this->ControlId . "_page_" . $this->strActionParameter, QApplication::$RequestUri, $this->prxPagination->RenderAsEvents($this->strActionParameter, true, $this->ControlId . "_page_" . $this->strActionParameter, false), $intIndex);
                }
            }
        } else {
            ...
            if ($this->intPageNumber < $intLeftBunchTrigger) {
                ...
                $strStartEllipsis = sprintf('<span class="page"><a id="%s" href="%s" %s>%s</a></span>', $this->ControlId . "_page_" . $this->strActionParameter, QApplication::$RequestUri, $this->prxPagination->RenderAsEvents($this->strActionParameter, true, $this->ControlId . "_page_" . $this->strActionParameter, false), 1);
            ...
            if ($this->intPageNumber > $intRightBunchTrigger) {
                ...
                $strEndEllipsis .= sprintf('<span class="page"><a id="%s" href="%s" %s>%s</a></span>', $this->ControlId . "_page_" . $this->strActionParameter, QApplication::$RequestUri, $this->prxPagination->RenderAsEvents($this->strActionParameter, true, $this->ControlId . "_page_" . $this->strActionParameter, false), $this->PageCount);
            }
        ...
        if ($this->intPageNumber >= $this->PageCount) {
            ...
            $this->strActionParameter = $this->intPageNumber + 1;
            $strNext = sprintf('<a id="%s" href="%s" %s>%s</a>', $this->ControlId . "_arrow_" . $this->strActionParameter, QApplication::$RequestUri, $this->prxPagination->RenderAsEvents($this->strActionParameter, true, $this->ControlId . "_arrow_" . $this->strActionParameter, false), $this->strLabelForNext);
        }
