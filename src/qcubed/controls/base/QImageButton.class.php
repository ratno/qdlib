...
class QImageButton extends QActionControl
{
    ...
    public function GetControlHtml()
    {
        ...
        if ($this->blnPrimaryButton) {
            $strToReturn = sprintf('<input type="image" name="%s" id="%s" %s%s />', $this->strControlId, $this->strControlId, $this->GetAttributes(), $strStyle);
        } else {
            $strToReturn = sprintf('<img name="%s" id="%s" %s%s />', $this->strControlId, $this->strControlId, $this->GetAttributes(), $strStyle);
        }

        $strToReturn .= sprintf('<input type="hidden" name="%s_x" id="%s_x" value=""/><input type="hidden" name="%s_y" id="%s_y" value=""/>', $this->strControlId, $this->strControlId, $this->strControlId, $this->strControlId);
