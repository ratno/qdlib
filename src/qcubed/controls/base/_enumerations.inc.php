...
abstract class QTinyMCEPlugin
{

    const AutoComplete = "ac";
    const Advhr = "advhr";
    const Advimage = "advimage";
    const Advlink = "advlink";
    ...
    const Iespell = "iespell";
    const Inlinepopups = "inlinepopups";
    const Insertdatetime = "insertdatetime";
    const Layer = "layer";
    const Legacyoutput = "legacyoutput";
    const Lists = "lists";
    const Media = "media";
    const Nonbreaking = "nonbreaking";
    const Noneditable = "noneditable";
    ...
    const Visualchars = "visualchars";
    const Xhtmlxtras = "xhtmlxtras";
