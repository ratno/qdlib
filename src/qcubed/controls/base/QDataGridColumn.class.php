 ...
 * @property string $ColName is the name of the column for identify the columns
...
class QDataGridColumn extends QBaseClass
{
    ...
    public function __get($strName)
    {
        switch ($strName) {
            ...
            case "FilterByCommand":
                return $this->arrFilterByCommand;
            case "FilterBoxSize":
                return $this->intFilterBoxSize;
            case "FilterInfo": {
                if (!isset($this->FilterByCommand['value'])) {
                    return null;
                }
            ...
            case "FilterColId":
                return $this->intFilterColId;

            case "FilterPrefix":
                return $this->strFilterPrefix;
            case "FilterPostfix":
                return $this->strFilterPostfix;

            case "FilterConstant":
                return $this->objFilterConstant;
            case "ActiveFilter":
    ...
    public function __set($strName, $mixValue)
    {
        switch ($strName) {
            ...
            case "ColName":
                try {
                    $this->strColName = QType::Cast($mixValue, QType::String);
                    break;
                } catch (QInvalidCastException $objExc) {
                    $objExc->IncrementOffset();
                    throw $objExc;
