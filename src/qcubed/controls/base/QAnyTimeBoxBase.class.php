 ...
 *        embed the actual character (such as ä) instead. Be careful to save your
...
class QAnyTimeBoxBase extends QTextBox
{
    ...
    public function __get($strName)
    {
        switch ($strName) {
            case 'AjaxOptions':
                return $this->arrAjaxOptions;
            case 'AskEra':
                return $this->blnAskEra;
            case 'AskSecond':
                return $this->blnAskSecond;
            case 'BaseYear':
                return $this->intBaseYear;
            case 'DayAbbreviations':
                return $this->arrDayAbbreviations;
            case 'DayNames':
                return $this->arrDayNames;
            case 'Earliest':
                return $this->dttEarliest;
            case 'EraAbbreviations':
                return $this->arrEraAbbreviations;
            case 'FirstDOW':
                return $this->intFirstDOW;
            case 'AtDateTimeFormat':
                return $this->strAtDateTimeFormat;
            case 'FormatUtcOffset':
                return $this->strFormatUtcOffset;
            case 'HideInput':
                return $this->blnHideInput;
            case 'LabelDayOfMonth':
                return $this->strLabelDayOfMonth;
            case 'LabelDismiss':
                return $this->strLabelDismiss;
            case 'LabelHour':
                return $this->strLabelHour;
            case 'LabelMinute':
                return $this->strLabelMinute;
            case 'LabelMonth':
                return $this->strLabelMonth;
            case 'LabelSecond':
                return $this->strLabelSecond;
            case 'LabelTimeZone':
                return $this->strLabelTimeZone;
            case 'LabelTitle':
                return $this->strLabelTitle;
            case 'LabelYear':
                return $this->strLabelYear;
            case 'Latest':
                return $this->dttLatest;
            case 'MonthAbbreviations':
                return $this->arrMonthAbbreviations;
            case 'MonthNames':
