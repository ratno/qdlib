...
class QCheckBoxColumn extends QDataGridColumn
{
     ...
     * Contoh: -- added by ratno@knoqdown.com, selasa 24 April 2012
     * $chk->SetCheckboxCallback($this,'chk_callback');
     * dan pada callbacknya:
     * $_ITEM adalah obj yg dipasang di datagrid
     * $chk_ctl adalah control dari checkbox yg dipasang
     * protected function chk_callback($_ITEM,$chk_ctl){
     *   dst
     * }
     *
    ...
    public function chkSelected_Render($_ITEM)
    {
        ...
        if (!$chkSelected) {
            ...
            if (null !== $this->objCheckboxCallback && null !== $this->strCheckboxCallbackFunc) {
                ...
                $obj = $this->objCheckboxCallback->$funcName($_ITEM, $chkSelected);
                // add by ratno@knoqdown.com, Selasa 24 April 2012
                // lakukan pengecekan jika ia masih qcheckbox maka obj akan berisi null selain itu returnkan aja alternatifnya
                if (is_null($obj)) {
                    // no return
                } else {
                    return $obj;
