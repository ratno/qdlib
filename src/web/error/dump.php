...
<table border="0" cellspacing="0" width="100%">
    <tr>
        <td nowrap="nowrap" class="headingLeft"><span class="headingLeftSmall"><?php _p($__exc_strType); ?> in PHP Script<br/></span><?php _p($_SERVER["PHP_SELF"]); ?></div>
        </td>
        <td nowrap="nowrap" class="headingRight">
            <b>PHP Version:</b> <?php _p(PHP_VERSION); ?>;&nbsp;&nbsp;<b>Zend Engine
                Version:</b> <?php _p(zend_version()); ?>;&nbsp;&nbsp;<b>QDF Version:</b> <?php _p(QDF_VERSION); ?><br/>
            <?php if (array_key_exists('OS', $_SERVER)) printf('<b>Operating System:</b> %s;&nbsp;&nbsp;', $_SERVER['OS']); ?>
            <b>Application:</b> <?php _p($_SERVER['SERVER_SOFTWARE']); ?>;&nbsp;&nbsp;<b>Server
                Name:</b> <?php _p($_SERVER['SERVER_NAME']); ?><br/>
...
<div class="page">
    ...
    if (isset($__exc_strRenderedPage)) {
        ...
        <b>Rendered Page:</b>&nbsp;&nbsp;
        <a href="<?php _p(__BASEURL__); ?>/error/already_rendered.php" target="_blank">
    ...
    <center><i><?php _p($__exc_strType); ?> Report Generated:&nbsp;&nbsp;<?php _p(date('l, F j Y, g:i:s A')); ?></i>
    </center>
    </font>
</div>
</body>
