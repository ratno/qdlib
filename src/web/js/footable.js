...
(function ($, w, undefined) {
    ...
    function Footable(t, o, id) {
        ...
        ft.resize = function () {
            var box_width = $("div.datagrid-box").width();
            var $table = $(ft.table);
            var info = {
            ...
            if (!pinfo || ((pinfo && pinfo.width && pinfo.width != info.width) || (pinfo && pinfo.height && pinfo.height != info.height))) {
                ...
                var breakpointName = (current == null ? (info.width > box_width ? ft.breakpoints[ft.breakpoints.length - 1]['name']:'default') : current['name']);
