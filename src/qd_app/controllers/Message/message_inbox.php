 ...
 * @subpackage List
 */
class MessageInbox extends PrivateMessageListFormBase
{
...
//		protected function Form_Load() {}
    ...
    {
        return MessageInbox::Run('MessageInbox', __BASEPATH__ . '/app/qd/views/Message/message_list.tpl.php');
    }
    ...
    protected function Form_Create()
    {
        ...
        $this->TaskActionName = 'Inbox';
        $this->CustomTitle = "Daftar Pesan Masuk";
        ...
        parent::Form_Create();
        $this->dtgPrivateMessages->AdditionalConditions = QQ::Equal(QQN::PrivateMessage()->ToUserId, $this->User->Id);
